...
(async () => {
  ...
  await fs.writeFile("rheumatoid-arthritis-group4-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("rheumatoid-arthritis-group4-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
